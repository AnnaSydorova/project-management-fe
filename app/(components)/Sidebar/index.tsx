...
function Sidebar() {
  ...
  const sidebarClassnames = `fixed flex flex-col h-[100%] justify-between shadow-xl transition-all duration-300 h-full z-40 overflow-y-auto bg-white  dark:bg-black ${isSidebarCollapsed ? "w-0 hidden" : "w-64"}`;
  return (
        ...
        <div className="z-50 flex min-h-[56px] w-64 items-center justify-between bg-white px-6 pt-3 dark:bg-black">
          ...
          {isSidebarCollapsed ? null : (
            ...
            >
              <X
                className={
                  "h-6 w-6 text-gray-800 hover:text-gray-500 dark:text-white"
                }
              />
            </button>
          )}
